...
@st.cache_data
def load_data():
    file_path = 'uploads/1804.xlsx'  # Ruta del archivo Excel
...
if df is None:
    ...
    if uploaded_file is not None:
        try:
            # Guardar el archivo subido en 'uploads/1804.xlsx'
            os.makedirs("uploads", exist_ok=True)  # Crear un directorio 'uploads' si no existe
            file_path = os.path.join("uploads", "1804.xlsx")
